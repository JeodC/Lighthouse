...
Same treatment for bone 6's rotation-Y element, and that's the whole mod: each thigh now swings to ~134 degrees instead of ~89. Values are just numbers to the engine - overshoot them and the legs windmill, which is a perfectly good way to confirm your mod is loading.
